...
class VideoRecorderCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        # Solution when modifying env steps and total timelaps.
        previous = self.model.num_timesteps - self.model.n_envs

        if previous // self.eval_freq < self.model.num_timesteps // self.eval_freq:
            print("Resetting eval env")
            ...
            print("Initial frame:", type(initial_frame), initial_frame is None)
